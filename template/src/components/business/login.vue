<template>
  <div>
    <box :padding-top="46" :padding-bottom="0" v-ref:box>
      <!--header slot-->
      ...
      <group style="margin-top:20px;background-color: transparent" label-width="4em" label-align="left" label-margin-right="5px">
      ...
      <group style="margin-top:30px;padding: 10px 15px;">
