...
<script>
  ...
  import Text from 'generals/form/text'
  import PopupPicker from 'generals/form/popup-picker'
  import Num from 'generals/form/number'
  import Checklist from 'generals/form/checklist'
  import Calendar from 'generals/form/calendar'
  import Datetime from 'generals/form/datetime'
  import Radio from 'generals/form/radio'
  import Switch from 'generals/form/switch'
  import Rater from 'generals/form/rater'
